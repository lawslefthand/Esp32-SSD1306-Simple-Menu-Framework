...
void menu_init(void *arg)
{
    ...
    ssd1306_init(&dev, 128, 64);
    ssd1306_contrast(&dev, 0xff);
    ssd1306_display_text(&dev, 0, "Option 1", 11, false);
    ssd1306_display_text(&dev, 1, "Option 2", 11, false);
    ssd1306_display_text(&dev, 2, "Option 3", 11, false);
    ssd1306_display_text(&dev, 3, "Option 4", 11, false);
